...
const file_internal_proto_auth_proto_rawDesc = "" +
	"\n" +
	"\x19internal/proto/auth.proto\"F\n" +
	"\fLoginRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"%\n" +
	"\rLoginResponse\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token25\n" +
	"\vAuthService\x12&\n" +
	"\x05Login\x12\r.LoginRequest\x1a\x0e.LoginResponseB\x17Z\x15internal/pb/auth;authb\x06proto3"
