...
type ChatServiceChatStream = {
  readonly methodName: string;
  readonly service: typeof ChatService;
  readonly requestStream: false;
  readonly responseStream: true;
  readonly requestType: typeof chat_pb.ChatStreamRequest;
...
export class ChatService {
  ...
  static readonly ChatStream: ChatServiceChatStream;
}
...
export class ChatServiceClient {
  ...
  chatStream(requestMessage: chat_pb.ChatStreamRequest, metadata?: grpc.Metadata): ResponseStream<chat_pb.ChatMessage>;
}
